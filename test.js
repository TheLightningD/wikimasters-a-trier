...
server.listen(0, '127.0.0.1', async () => {
  ...
  const inventory = await run({ COLLECTION_ONLY: 'true', WISHLIST_SYNC: 'true', WM_COLLECTION_URL: `http://127.0.0.1:${port}/collection.html?all-labeled=1` });
